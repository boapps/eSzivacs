...
//            final Intent intent = new Intent(, MainPage.class);
//            this.startActivity(intent);
    ...
    protected boolean isValidFragment(String fragmentName) {
        return PreferenceFragment.class.getName().equals(fragmentName)
                || AnalyticsFragment.class.getName().equals(fragmentName)
     ...
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class AnalyticsFragment extends PreferenceFragment {
        @Override
...
//            bindPreferenceSummaryToValue(findPreference("notifications_new_message"));
        ...
        public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
            if (key.equals("notifications_new_message")) {
                ...
                if (sync)
                    BackgroundTaskService.scheduleRepeat(getActivity());
                else
                    BackgroundTaskService.cancelRepeat(getActivity());
